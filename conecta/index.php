...
<html lang="pt-br">
    ...
    <body>
    <center><h2 style="color: #A7C7E7">CONECTA JOVEM MARINGÁ</h2>
        <hr>
        <br>
        <br>
        <div class="row justify-content-center row-cols-1 row-cols-md-3 mb-3 text-center">
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sw">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="#A7C7E7" class="bi bi-person" viewBox="0 0 16 16">
